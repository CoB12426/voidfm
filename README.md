...
**TTS** — [Chatterbox TTS](https://github.com/resemble-ai/chatterbox) runs in-process.
...
Open the Android app, enter the Ubuntu host's IP address and port in the Settings screen, then go ON AIR.
